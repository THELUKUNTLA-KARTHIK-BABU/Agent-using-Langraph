...
groq_api_key = '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'  # Groq API key
os.environ["TAVILY_API_KEY"] = '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'  # Set Tavily API key
...
if __name__ == '__main__':
    ...
    uvicorn.run(app, host='127.0.0.1', port=8080)  # Start the app on localhost with port 8080
